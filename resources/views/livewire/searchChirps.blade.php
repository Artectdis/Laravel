...
$chirps = computed(function () {
    return Chirp::where('message', 'like', "%{$this->query}%")
                ->paginate(10);
});
?>
...
<main class="px-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex flex-row mb-4 border-b border-gray-300">
            <a class="btn btn-ghost !px-8 !py-8 !rounded-none !border-0 !text-xl">Users</a>
            <a href="/search/chirps/?query={{ $query }}" class="btn btn-ghost !px-8 !py-8 !rounded-none !border-0 !border-b-2 !border-[#5580d2] !text-xl">Chirps</a>
        </div>
