...
<main class="px-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex flex-row mb-4 border-b border-gray-300">
            ...
            <a href="/search/chirps/?query={{ $query }}" class="btn btn-ghost !px-8 !py-8 !rounded-none !border-0 !text-xl">Chirps</a>
        </div>
        ...
        <div class="card p-6 bg-base-100 space-x-3 mb-4 group-hover:!bg-gray-300 !transition-all duration-500 ease-in-out">
