        ...
        <div class="navbar-end gap-2">
            <button type="submit" id="dark-toggle"
                style="background: none; border: none; padding: 0; cursor: pointer"><svg
                    ...
                    class="mode-moon dark-toggle size-6 fill-[#808080] hover:fill-[#4697E7] transition-colors duration-500 ease-in-out mx-2"
                    alt="Dark Logo">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    class="light-toggle hidden dark:block size-6 fill-[#fff] hover:fill-[#ff0] transition-colors duration-500 ease-in-out mx-2"
                    alt="Light Logo">
                    <path
                ...
                <a href="/profile/{{ auth()->user()->id }}">
                    <div
                        ...
                        <strong>{{ auth()->user()->name }} </strong> <img src="{{ auth()->user()->avatar_url }}"
                            class="nav-avatar size-7 rounded-full">
                    </div>
                </a>
