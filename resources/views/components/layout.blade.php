...
<body class="min-h-screen flex flex-col bg-base-200 font-sans">
    <nav class="navbar bg-base-100">
        ...
        <div class="navbar-end gap-2">
            <button type="submit" id="dark-toggle" style="background: none; border: none; padding: 0; cursor: pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    class="dark-toggle dark:hidden size-6 fill-[#808080] hover:fill-[#4697E7] transition-colors duration-500 ease-in-out mx-2"
                    alt="Dark Logo">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    class="light-toggle hidden dark:block size-6 fill-[#ff0] hover:fill-[#0ff] transition-colors duration-500 ease-in-out mx-2"
                    alt="Light Logo">
                    <path
    ...
    @error('avatar')
        <div class="toast toast-top toast-center animate-fade-out">
            <div class="alert alert-danger">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="h-6 w-6 shrink-0"
                    class="size-6">
                    <path fill-rule="evenodd"
...
<script>
    ...
    toggle.addEventListener('click', () => {
        const isDark = document.documentElement.classList.toggle('dark-mode-filter'); // html +- dark
        localStorage.setItem('theme', isDark ? 'dark' : 'light'); // theme.dark
    });
</script>
