...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.supabase.driver' => 'string',
            'filesystems.disks.supabase.key' => 'string',
            'filesystems.disks.supabase.secret' => 'string',
            'filesystems.disks.supabase.region' => 'string',
            'filesystems.disks.supabase.bucket' => 'string',
            'filesystems.disks.supabase.endpoint' => 'string',
            'filesystems.disks.supabase.use_path_style_endpoint' => 'boolean',
            'filesystems.disks.supabase.url' => 'string',
...
'database.connections.pgsql.prefix','database.connections.pgsql.prefix_indexes','database.connections.pgsql.search_path','database.connections.pgsql.sslmode','database.connections.pgsql.timezone',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.supabase.driver','filesystems.disks.supabase.key',
'filesystems.disks.supabase.secret','filesystems.disks.supabase.region','filesystems.disks.supabase.bucket','filesystems.disks.supabase.endpoint','filesystems.disks.supabase.use_path_style_endpoint',
'filesystems.disks.supabase.url','filesystems.links./var/www/html/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.serialization','image.driver','image.options.autoOrientation','image.options.decodeAnimation','image.options.backgroundColor',
'image.options.strip','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'auth.login','auth.register','blog','chirps.edit','components.chirp',
'components.layout','home','layouts.app','posts.index','profile',
'profileView','section','test','welcome','laravel-exceptions-renderer::components.badge',
...
'APP_TIMEZONE','ASSET_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
...
'SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','SUPABASE_ACCESS_KEY','SUPABASE_SECRET_KEY',
'SUPABASE_REGION','SUPABASE_BUCKET','SUPABASE_ENDPOINT','SUPABASE_PUBLIC_URL','BROADCAST_CONNECTION',
